...
// At the start of your script or before calling buildGithubCheck, set the global variables
def globalSettings = initializeGlobals('your_app_id', 'your_installation_id', 'your_organization_name')
APP_ID = globalSettings.APP_ID
INSTALLATION_ID = globalSettings.INSTALLATION_ID
ORGANIZATION_NAME = globalSettings.ORGANIZATION_NAME
